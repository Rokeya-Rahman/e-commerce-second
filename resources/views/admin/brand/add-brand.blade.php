                            ...
                            {{ Form::open(['route' => 'save-brand', 'method' => 'POST']) }}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body mt-3">
                                        <div class="col-md-11 mx-auto">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea id="editor" name="brand_description" class="form-control">{{ old('brand_description') }}</textarea>
                                    ...
                                    <div class="card-footer text text-center">
                                        <input type="submit" class="btn bg-cyan btn-rounded text-white my-1" value="Save Brand Information">
                                    </div>
                                </div>
